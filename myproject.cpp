...
//main function
int main()
{ showbill Order1;//creating object of child class(showbill)
   int Bill=Order1.returntotalbill();//storing return value of function in Bill variable
   Order1.show(Bill);//calling show() function by passing bill variable
  return 0;
 }